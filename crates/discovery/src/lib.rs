...
pub use record::{
    NodeId, PeerRecord, RecordError, Region, Role, RoleSet, MAX_ADDRESSES, MAX_MARKET_IDS,
    MAX_PROTOCOLS, MAX_REGIONS,
};
pub use service::{
...
pub use table::{
    signed_record, IngestOutcome, Liveness, PeerConfig, PeerEntry, PeerTable, REP_BAD, REP_GOOD,
    REP_INITIAL,
};
